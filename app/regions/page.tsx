...
const COPY = {
  ru: { title: 'Регионы Грузии: продукты и производители',
        description: 'Мёд, чай, вино и специи по регионам Грузии: Кахетия, Гурия, Аджария, Рача, Самегрело. Чем отличаются продукты и кто их делает.',
        h1: 'Регионы Грузии',
  ...
  en: { title: 'Regions of Georgia: Products and Producers',
        description: 'Honey, tea, wine and spices by region of Georgia: Kakheti, Guria, Adjara, Racha, Samegrelo. How the products differ and who makes them.',
  ...
  ka: { title: 'საქართველოს რეგიონები: პროდუქცია',
        description: 'თაფლი, ჩაი, ღვინო და სანელებლები საქართველოს რეგიონების მიხედვით: კახეთი, გურია, აჭარა, რაჭა, სამეგრელო. ვინ აწარმოებს და რით განსხვავდება.',
