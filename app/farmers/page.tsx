...
export const metadata: Metadata = {
  title: 'Наши фермеры | BAZARI ARA',
  description: 'Познакомьтесь с фермерами и хозяйствами, которые производят натуральные продукты для BAZARI ARA.',
};
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/farmers/chventan" className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden group border border-ink-200 block">
