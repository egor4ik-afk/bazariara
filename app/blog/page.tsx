...
const COPY = {
  ru: { title: 'Путеводитель по Грузии: маршруты и советы',
        description: 'Маршруты по Грузии, хайкинг и регионы: что посмотреть, что попробовать на месте и что привезти домой. Практические советы от тех, кто живёт в Тбилиси.',
  ...
  en: { title: 'Georgia Travel Guide: Routes and Tips',
        description: 'Routes across Georgia, hiking and regions: what to see, what to try and what to bring home. Practical travel advice from people who live in Tbilisi.',
  ...
  ka: { title: 'საქართველოს გზამკვლევი: მარშრუტები',
        description: 'მარშრუტები საქართველოში, ლაშქრობა და რეგიონები: რა ვნახოთ, რა გავსინჯოთ და რა წავიღოთ სახლში. პრაქტიკული რჩევები მოგზაურებისთვის.',
