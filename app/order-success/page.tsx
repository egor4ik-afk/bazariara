    ...
    <div className="bg-cream-100 min-h-screen text-ink-900 flex items-center justify-center p-4">
      <main className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/orders"
            className="inline-block bg-brand-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-brand-500 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-brand-600/30"
          >
