...
function RelatedProductCard({ category, id }: { category: string; id: string }) {
  ...
  return (
    <Link href={`/${language}/products/${product.categoryKey}/${product.id}`}
      className="block bg-surface rounded-lg hover:shadow-brand-600/20 transition-shadow duration-300">
  ...
  return (
    <div className="bg-cream-100 min-h-screen text-ink-900">
      <main className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="bg-surface rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm">
